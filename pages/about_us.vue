<template>
  <div class="max-w-7xl mx-auto py-8 px-5">
    <div
      class="py-40 rounded flex place-content-center bg-[url('https://plus.unsplash.com/premium_photo-1667621221108-d9ff42adee84?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80')] bg-cover bg-center"
    >
      <h1 class="text-5xl font-bold text-center text-white">About Us</h1>
    </div>
    <div class="mt-10 h-7 flex justify-center items-center gap-3">
      <!-- fb -->
      <a href="#" class="h-full">
        <svg
          class="h-full border-[3px] border-black rounded-full"
    ...
    <div class="mt-16 flex flex-col gap-5 lg:flex-row">
      <div class="flex items-center text-lg lg:flex-1">
        歡迎來到我們的咖啡電商網站！<br /><br />
        我們是一個致力於提供高品質咖啡豆和現磨咖啡服務的公司。我們的咖啡豆來自世界各地的頂尖咖啡種植園，我們致力於提供最好的咖啡品質和口感。<br /><br />
        我們的團隊由咖啡烘焙師、品鑑師和服務專家組成，他們都具有豐富的咖啡行業經驗和專業知識。我們的烘焙師使用最先進的烘焙技術，精選每個批次的咖啡豆，並確保每個杯子都具有最佳的風味和香氣。<br /><br />
        我們提供現磨咖啡服務，以確保您享用到最新鮮的咖啡。我們的咖啡機經過嚴格測試和選擇，只選擇最優質的咖啡機提供給客戶。我們還提供定制化的咖啡服務，讓您的每一杯咖啡都能夠滿足您的需求。<br /><br />
        我們堅信，好的咖啡不僅僅是一種飲料，更是一種生活方式和體驗。我們希望通過我們的服務和產品，為您帶來更愉悅的咖啡體驗。<br /><br />
        感謝您選擇我們的咖啡電商網站，我們期待著為您提供最優質的咖啡和服務。如有任何問題或建議，請隨時聯繫我們的客戶服務團隊。<br />
      </div>
      <div class="h-96 lg:h-[40rem] lg:flex-1">
        <img
          class="w-full h-full rounded object-cover"
          src="https://images.unsplash.com/photo-1527596428171-7885b82c91c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=737&q=80"
          alt=""
        />
      </div>
    </div>
    <div class="mt-8 flex items-center gap-5 h-80">
      <ClientOnly>
        <map-container class="flex-1"></map-container>
      </ClientOnly>
      <div class="flex-1">
...
// onMounted(() => {
//   const map = L.map(mapRef.value).setView([25.01768558420301, 121.29862288250831], 13)
//   // const map = L.map('mapRef', {
//   //   center: [25.01768558420301, 121.29862288250831],
//   //   zoom: 13
//   // })
//   if (process.client) {
